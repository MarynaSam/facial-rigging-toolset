...
def name_and_parent_groups(list_of_names, grp_to_parent):
...
def build_structure():
    ...
    name_and_parent_groups(FACE_GROUP, MAIN_GROUP)
    name_and_parent_groups(DONT_GROUP, FACE_GROUP[2])
    name_and_parent_groups(FASCIA_GROUP, DONT_GROUP[0])
    name_and_parent_groups(EYELID_SETUP_GROUP, DONT_GROUP[5])